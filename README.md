...
```mermaid
flowchart TD
    A[🗣️ You <br> Share a voice note or photo] --> B[🎧 The Listener & Translator <br> Hears and translates to English]
    B --> C[🏷️ The Sorter <br> Figures out what kind of problem it is]
    C --> D[🗺️ The Map Reader <br> Finds the exact location]
    D --> E[📬 The Delivery Agent <br> Packages the complaint]
    E --> F[🏢 The Right Government Office <br> Gets the message and fixes it!]
