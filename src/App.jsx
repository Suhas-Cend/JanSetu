    ...
    <div className="max-w-4xl mx-auto w-full">
      ...
      <div className="space-y-4">
        ...
        <div className={`p-5 rounded-xl border transition-all duration-500 flex items-center justify-between ${step >= 5 ? 'bg-[#11212D] border-[#9BA8AB]/20 opacity-100 translate-y-0 card-shadow' : 'bg-[#11212D]/20 border-transparent opacity-0 translate-y-4'}`}>
          <div className="flex items-center gap-4">
            <div className={`w-10 h-10 rounded-full flex items-center justify-center ${step >= 6 ? 'bg-[#6BBF4A]/20 text-[#6BBF4A]' : 'bg-[#FF9800]/20 text-[#FF9800] animate-spin'}`}>
              <Icon name={step >= 6 ? "CheckCircle2" : "RefreshCw"} size={22} />
            </div>
            <div>
          ...
          <span className={`font-bebas text-[18px] ${step >= 6 ? 'text-[#6BBF4A]' : 'text-[#FF9800]'}`}>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="relative w-28 h-28 flex items-center justify-center">
              <svg className="w-full h-full transform -rotate-90" viewBox="0 0 100 100">
                ...
                <circle
                  cx="50" cy="50" r="40" stroke="#6BBF4A" strokeWidth="8"
